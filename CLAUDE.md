...
**Current test files (475 tests, 22 files):**
...
- `SavingsGoals.test.jsx` — empty state, add form, progress calculation, single-click delete, every field reachable by label, Enter submits, edit flow (pre-fill, `updateSavingsGoal` not `addSavingsGoal`, unlinking the fund clears the year, cancelling leaves no values behind)
